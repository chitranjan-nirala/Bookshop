...
function Navbar() {
// using hook useeffect to mange the change on clinking 
const [theme, setTheme] = useState(
  localStorage.getItem("theme") ? localStorage.getItem("theme") : "light"
);

const element = document.documentElement;
  // This useEffect checks and applies the correct theme
  useEffect(() => {
    if (theme === "dark") {
  ...
  }, []); // Corrected useEffect syntax and added cleanup logic
    ...
    ${sticky?"sticky-navbar shadow-md bg-base-200 dark:bg-slate-600 dark: text-white  duration-300  transition-all ease-in-out":""}`}>
      <div className="navbar ">
        ...
        <div className="navbar-end space-x-3">
          ...
          <div className="">
            <a className=" bg-black text-white px-3 py-2 cursor-pointer  rounded-md hover:bg-slate-800 duration-300"
